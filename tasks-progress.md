Tasks Progress — Profile Website
...
- Move items from "To Do" to "In Progress" when started and to "Done" when completed.
- Update the summary counts after each status change.
